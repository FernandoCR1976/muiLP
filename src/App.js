...
export default function App() {
  return (
    <ThemeProvider theme={theme}> {/* Aplicamos el tema personalizado */}
      ...
      {/* AppBar */}
      <AppBar position="static"> {/* Barra de navegación superior */}
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
      ...
      >
        <Container maxWidth="sm"> {/* Contenedor con ancho limitado */}
          <Typography
            component="h1"
            variant="h2"
            align="center"
          ...
          <Typography variant="h5" align="center" color="text.secondary" paragraph>
            {/* Subtítulo */}
            En Belleza Radiante, te ofrecemos una amplia gama de cosméticos de alta calidad para realzar tu belleza natural.
          </Typography>
          <Box
            sx={{
              display: 'flex',
      ...
      <Container sx={{ py: 8 }} maxWidth="md">
        ...
        <Grid container spacing={4}> {/* Grid para mostrar los productos */}
          ...
          {[1, 2, 3].map((item) => (
            <Grid item key={item} xs={12} sm={6} md={4}>
              ...
              >
                ...
                <CardActions>
                  <Button size="small">Ver detalles</Button> {/* Botón para ver detalles */}
                  <Button size="small">Agregar al carrito</Button> {/* Botón para agregar al carrito */}
                </CardActions>
              </Card>
            </Grid>
          ))}
